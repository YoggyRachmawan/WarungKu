    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item">Tambah Tempat Belanja</a></li>
            </ol>
            <div class="card mb-4">
                <div class="card-header d-flex">
                    <label> Form Tambah Tempat Belanja</label>
                    <a href="/daftarTempatBelanja" type="button" class="btn btn-warning btn-sm float-right ms-auto"><i
                            class="bi bi-arrow-bar-left"></i>
                        Kembali
                    </a>
                </div>
                <form action="/inputTempatBelanja" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="namaTempat" class="form-label">Nama Tempat</label>
                            <input type="text" name="nama_tempat" class="form-control form-control-sm @error('nama_tempat') is-invalid @enderror" id="namaTempat" autocomplete="off">
                            @error('nama_tempat')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kontak"
                                class="form-control form-control-sm @error('kontak') is-invalid @enderror" id="kontak" autocomplete="off">
                            @error('kontak')
                                <small style="color: red;">{{ $message }}</small>
                            @enderror
                        </div>
